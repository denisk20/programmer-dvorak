...
<html>
	<head>
		<typingtutor:head />
		<title>Programmer Dvorak typing tutorial: Lesson 5: Comprehensive, including O and N</title>
	</head>
		<body> 		<typingtutor:keyboard/> 
		<div class="content">
			<h1>Lesson 5: Comprehensive, including O and N</h1>
			<div class="nav">
				<a href="/lessons/lesson04.jsp"><img src="/img/left-arrow.png"
													alt="Previous lesson"
													title="Previous lesson: Lesson 4: Introducing O and N: Home row, third fingers" /></a>
				<a href="/index.html#lessons" class="toc"><img src="/img/toc.png"
													   alt="Table of contents" title="Table of contents" /></a> <a
					href="/lessons/lesson06.jsp"><img src="/img/right-arrow.png"
												 alt="Next lesson" title="Next lesson: Lesson 6: Introducing A and S: Home row, fourth fingers" /></a>
			</div>
