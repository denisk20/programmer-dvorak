...
<html>
	<head>
		<typingtutor:head />
		<title>Programmer Dvorak typing tutorial: Lesson 27: Comprehensive, including ; and Z</title>
	</head>
	<body>
		<div class="content">
			<h1>Lesson 27: Comprehensive, including ; and Z</h1>
			<div class="nav">
				<a href="/lessons/lesson26.jsp"><img src="/img/left-arrow.png"
													 alt="Previous lesson"
													 title="Lesson 26: Introducing ; and Z: Fourth fingers reaching down"/></a>
				<a href="/index.html" class="toc"><img src="/img/toc.png"
													   alt="Table of contents" title="Table of contents" /></a> <a
					href="/lessons/lesson28.jsp"><img src="/img/right-arrow.png"
												  alt="Next lesson" title="Next lesson: Lesson 28: Introducing X and B: Index fingers stretching down"/></a>
			</div>
