...
<html>
	<head>
		<typingtutor:head />
		<title>Programmer Dvorak typing tutorial: Lesson 21: Comprehensive, including K and M</title>
	</head>
	<body>
		<div class="content">
			<h1>Lesson 21: Comprehensive, including K and M</h1>
			<div class="nav">
				<a href="/lessons/lesson20.jsp"><img src="/img/left-arrow.png"
													 alt="Previous lesson"
				...
				<a href="/index.html" class="toc"><img src="/img/toc.png"
					...
					href="/lessons/lesson22.jsp"><img src="/img/right-arrow.png"
												  alt="Next lesson" title="Next lesson: Lesson 22: Introducing J and W: Second fingers reaching down"/></a>
			</div>
