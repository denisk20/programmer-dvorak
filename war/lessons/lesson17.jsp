...
<html>
	<head>
		<typingtutor:head />
		<title>Programmer Dvorak typing tutorial: Lesson 17: Comprehensive, including ' and L</title>
	</head>
	<body>
		<div class="content">
			<h1>Lesson 17: Comprehensive, including ' and L</h1>
			<div class="nav">
				<a href="/lessons/lesson16.jsp"><img src="/img/left-arrow.png"
													 alt="Previous lesson"
													 title="Lesson 16: Introducing ' and L: Fourth fingers reaching up"/></a>
				<a href="/index.html" class="toc"><img src="/img/toc.png"
													   alt="Table of contents" title="Table of contents" /></a> <a
					href="/lessons/lesson18.jsp"><img src="/img/right-arrow.png"
												  alt="Next lesson" title="Next lesson: Lesson 18: Introducing Y and F: Index fingers stretching up"/></a>
			</div>
