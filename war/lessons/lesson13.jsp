...
<html>
	<head>
		<typingtutor:head />
		<title>Programmer Dvorak typing tutorial: Lesson 13: Comprehensive, including . and C</title>
	</head>
	<body>
		<div class="content">
			<h1>Lesson 13: Comprehensive, including . and C</h1>
			<div class="nav">
				<a href="/lessons/lesson12.jsp"><img src="/img/left-arrow.png"
													 alt="Previous lesson"
													 title="Lesson 12: Introducing . and C: Second fingers reaching up"/></a>
				<a href="/index.html" class="toc"><img src="/img/toc.png"
													   alt="Table of contents" title="Table of contents" /></a> <a
					href="/lessons/lesson14.jsp"><img src="/img/right-arrow.png"
												  alt="Next lesson" title="Next lesson: Lesson 14: Introducing , and R: Third fingers reaching up"/></a>
			</div>
