...
<html>
	<head>
		<typingtutor:head />
		<title>Programmer Dvorak typing tutorial: Lesson 23: Comprehensive, including J and W</title>
	</head>
	<body>
		<div class="content">
			<h1>Lesson 23: Comprehensive, including J and W</h1>
			<div class="nav">
				<a href="/lessons/lesson22.jsp"><img src="/img/left-arrow.png"
													 alt="Previous lesson"
													 title="Lesson 22: Introducing J and W: Second fingers reaching down"/></a>
				<a href="/index.html#lessons" class="toc"><img src="/img/toc.png"
													   alt="Table of contents" title="Table of contents" /></a> <a
					href="/lessons/lesson24.jsp"><img src="/img/right-arrow.png"
												  alt="Next lesson" title="Next lesson: Lesson 24: Introducing Q and V: Third fingers reaching down"/></a>
			</div>
